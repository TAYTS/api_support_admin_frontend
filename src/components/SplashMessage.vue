...
.splash__container {
  ...
  overflow: hidden;
  font-size: 12px;
  background-image: linear-gradient(to right bottom, #d099ef, #9f2edf);
...
.circle--outer {
  ...
  background-image: linear-gradient(to right bottom, #c364ce, #693cc3);
...
.circle--inner {
  ...
  background-image: linear-gradient(to right bottom, #b960d2, #663bc4);
  box-shadow: 0px 0px 20px -8px #000;
}
.four {
  position: absolute;
